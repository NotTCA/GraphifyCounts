$(document).ready(function () {
  ...
  function channelSearch(search, maxResults) {
    fetch(
      "https://api.subscriberwars.space/youtube/channel-search/" +
        maxResults +
        "/" +
        search
    )
      ...
      .then((data) => {
        ...
        const param = window.location.href.split("?r=")[1] || "mixernov4.html";
        const redirectLink = `${
          window.location.href.split(window.location.pathname)[0]
        }/youtube/${param}.html?u=`;
        ...
        link1.href = redirectLink + data.items[0].id.channelId;
        ...
        link2.href = redirectLink + data.items[1].id.channelId;
        ...
        link3.href = redirectLink + data.items[2].id.channelId;
        ...
        link4.href = redirectLink + data.items[3].id.channelId;
        ...
        link5.href = redirectLink + data.items[4].id.channelId;
      });
  }
});
